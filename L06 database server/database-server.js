...
async function fetchTasksFromMingiDB() {
...
async function addTaskToMingiDB(task) {
    const loadingIndicator = document.getElementById("loading-indicator");
    if (loadingIndicator)
        loadingIndicator.style.display = "block";
    try {
...
async function deleteTaskFromMingiDB(taskId) {
    const loadingIndicator = document.getElementById("loading-indicator");
    if (loadingIndicator)
        loadingIndicator.style.display = "block";
    try {
...
async function updateTaskInMingiDB(taskId, updatedTask) {
    const loadingIndicator = document.getElementById("loading-indicator");
    if (loadingIndicator)
        loadingIndicator.style.display = "block";
    try {
